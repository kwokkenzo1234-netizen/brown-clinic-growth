        ...
        <div className="container relative py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-fade-up delay-200">
              ...
              {/* Floating Card */}
              <div className="absolute -left-4 bottom-12 bg-card rounded-2xl p-4 shadow-xl animate-float hidden md:block">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="group p-6 bg-card rounded-2xl border border-border hover:border-primary/30 transition-all duration-300 hover:shadow-lg animate-fade-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {beforeAfter.map((item, index) => (
              <div
                key={index}
                className="bg-card rounded-2xl overflow-hidden shadow-lg animate-fade-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                ...
                className="bg-card rounded-2xl p-8 border border-border animate-fade-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
